...
void Filter::filter1d(Grid3d& gr, int maskWidth_2, int numZeroFreq_2, Coordinate coord) {

    int a1 = gr.sizeComplex().*getMemberPtrCoord<int>(coord) / 2 - maskWidth_2 - numZeroFreq_2;
    int b1 = gr.sizeComplex().*getMemberPtrCoord<int>(coord) / 2 - numZeroFreq_2;
    int a2 = gr.sizeComplex().*getMemberPtrCoord<int>(coord) / 2 + maskWidth_2 + numZeroFreq_2;
    int b2 = gr.sizeComplex().*getMemberPtrCoord<int>(coord) / 2 + numZeroFreq_2;
...
void Filter::lowFrequencyFilter(Grid3d & gr)
{
