...
void LowFreqFilter::filter1d(Grid3d* gr, int maskWidth_2, int numZeroFreq_2, Coordinate coord) {
    ...
    int a1 = gr->sizeComplex().*getMemberPtrCoord<int>(coord) * 0.5 
        - maskWidth_2 - numZeroFreq_2;
    int b1 = gr->sizeComplex().*getMemberPtrCoord<int>(coord) * 0.5
        - numZeroFreq_2;
    int a2 = gr->sizeComplex().*getMemberPtrCoord<int>(coord) * 0.5
        + maskWidth_2 + numZeroFreq_2;
    int b2 = gr->sizeComplex().*getMemberPtrCoord<int>(coord) * 0.5
        + numZeroFreq_2;
